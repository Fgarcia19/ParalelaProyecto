...
void TSPRec(double adj[N][N], double curr_bound, double curr_weight,int level, int curr_path[], int to)
{

	if (level==N and curr_path[level-1]==to)
	{
        /*
...
void TSP(int from, int to, double adj[N][N])
{
	int curr_path[N+1];
	...
	visited[from] = true;
	curr_path[0] = from;
	TSPRec(adj, curr_bound, 0, 1, curr_path,to);
	/*
		#pragma dsa,das
			for i < n
				visit[i]=true
...
/*
    ...
    {0, 1.0, -1, 1.5, -1, 2.0, -1, -1, 1.8, 2.0},
{1.0, 0, 1.1, 0.6, 1.1, -1, 1.2, 1.8, 1.2, 1.3},
{-1, 1.1, 0, 0.9, 1.0, 1.9, 0.6, 1.9, 0.7, -1},
{1.5, 0.6, 0.9, 0, 0.5, 0.6, -1, 1.9, 0.7, -1},
{-1, 1.1, 1.0, 0.5, 0, -1, -1, 0.7, 0.5, 1.6},
{2.0, -1, 1.9, 0.6, -1, 0, 1.7, 1.2, 1.0, -1},
{-1, 1.2, 0.6, -1, -1, 1.7, 0, 0.8, 1.6, 1.2},
{-1, 1.8, 1.9, 1.9, 0.7, 1.2, 0.8, 0, 1.9, 0.9},
{1.8, 1.2, 0.7, 0.7, 0.5, 1.0, 1.6, 1.9, 0, 1.0},
{2.0, 1.3, -1, -1, 1.6, -1, 1.2, 0.9, 1.0, 0}
